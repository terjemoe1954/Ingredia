        ...
        [
            ...
            HelpSection(
                ...
                paragraphs: [
                    ...
                    "Hvis kameraet ikke får lest koden, kan du skrive inn tallene under strekkoden manuelt.",
            ...
            HelpSection(
                ...
                paragraphs: [
                    ...
                    "Vanlige produktoppslag krever ingen API-nøkkel. Dekningen varierer mellom land, så kontroller alltid emballasjen."
                ]
            ),
            HelpSection(
        ...
        [
            ...
            HelpSection(
                ...
                paragraphs: [
                    ...
                    "If the camera cannot read the code, you can enter the numbers below the barcode manually.",
            ...
            HelpSection(
                ...
                paragraphs: [
                    ...
                    "Regular product lookups do not require an API key. Coverage varies by country, so always verify the packaging."
                ]
            ),
            HelpSection(
        ...
        [
            ...
            HelpSection(
                ...
                paragraphs: [
                    ...
                    "หากกล้องอ่านรหัสไม่ได้ คุณสามารถกรอกตัวเลขใต้บาร์โค้ดเองได้",
            ...
            HelpSection(
                ...
                paragraphs: [
                    ...
                    "การค้นหาสินค้าทั่วไปไม่ต้องใช้คีย์ API ความครอบคลุมแตกต่างกันไปตามประเทศ ดังนั้นควรตรวจสอบบรรจุภัณฑ์ทุกครั้ง"
                ]
            ),
            HelpSection(
