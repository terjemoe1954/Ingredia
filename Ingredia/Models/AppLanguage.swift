...
enum AppTextKey {
    ...
    case manualBarcodeTitle
    case manualBarcodeMessage
    case barcode
    case lookupProduct
    case cameraUnavailableTitle
    case cameraUnavailableMessage
    case cameraPermissionDeniedMessage
    case openSettings
    ...
    case dataSourceInactiveDescription
    ...
    case productLookupDataSourceUnauthorized
    ...
    case dataSource
    case dataSourceMergedDescription
...
enum AppText {
    ...
    private static func norwegian(_ key: AppTextKey) -> String {
        ...
        case .enterBarcodeManually: "Skriv inn strekkode manuelt"
        case .manualBarcodeTitle: "Skriv inn strekkode"
        case .manualBarcodeMessage: "Bruk tallene under strekkoden hvis kameraet ikke får lest den."
        case .barcode: "Strekkode"
        case .lookupProduct: "Hent produkt"
        case .cameraUnavailableTitle: "Kamera ikke tilgjengelig"
        case .cameraUnavailableMessage: "Ingredia finner ikke et tilgjengelig kamera på denne enheten."
        case .cameraPermissionDeniedMessage: "Gi Ingredia tilgang til kameraet i Innstillinger for å skanne strekkoder."
        case .openSettings: "Åpne Innstillinger"
        ...
        case .dataSourceInactiveDescription: "Denne kilden brukes ikke før den er konfigurert."
        case .dataSourceAlternativeSearchAvailable: "Støtter søk etter alternative varer"
        case .dataSourceAlternativeSearchUnavailable: "Støtter bare oppslag av enkeltprodukt"
        ...
        case .productLookupDataSourceUnauthorized: "Datakilden godtar ikke forespørselen akkurat nå."
        case .limitedProductDataTitle: "Begrensede produktdata"
        case .limitedProductDataBody: "Produktdataene mangler nok ingrediens- eller allergeninformasjon til en trygg vurdering. Kontroller alltid emballasjen nøye."
        ...
        case .dataSourceMergedDescription: "Produktdata er slått sammen fra flere aktive kilder."
    ...
    private static func english(_ key: AppTextKey) -> String {
        ...
        case .enterBarcodeManually: "Enter barcode manually"
        case .manualBarcodeTitle: "Enter barcode"
        case .manualBarcodeMessage: "Use the numbers below the barcode if the camera cannot read it."
        case .barcode: "Barcode"
        case .lookupProduct: "Look Up Product"
        case .cameraUnavailableTitle: "Camera Unavailable"
        case .cameraUnavailableMessage: "Ingredia cannot find an available camera on this device."
        case .cameraPermissionDeniedMessage: "Allow Ingredia to use the camera in Settings to scan barcodes."
        ...
        case .dataSourceInactiveDescription: "This source is not used until it is configured."
        case .dataSourceAlternativeSearchAvailable: "Supports alternative product search"
        case .dataSourceAlternativeSearchUnavailable: "Supports only single-product lookup"
        ...
        case .productLookupDataSourceUnauthorized: "The data source is not accepting requests right now."
        case .limitedProductDataTitle: "Limited product data"
        case .limitedProductDataBody: "The product data lacks enough ingredient or allergen information for a reliable assessment. Always check the packaging carefully."
        ...
        case .dataSourceMergedDescription: "Product data is merged from multiple active sources."
    ...
    private static func thai(_ key: AppTextKey) -> String {
        ...
        case .enterBarcodeManually: "กรอกบาร์โค้ดเอง"
        case .manualBarcodeTitle: "กรอกบาร์โค้ด"
        case .manualBarcodeMessage: "ใช้ตัวเลขใต้บาร์โค้ดหากกล้องอ่านไม่ได้"
        case .barcode: "บาร์โค้ด"
        case .lookupProduct: "ค้นหาสินค้า"
        case .cameraUnavailableTitle: "ไม่มีกล้องให้ใช้งาน"
        case .cameraUnavailableMessage: "Ingredia ไม่พบกล้องที่ใช้งานได้บนอุปกรณ์นี้"
        case .cameraPermissionDeniedMessage: "อนุญาตให้ Ingredia ใช้กล้องในการตั้งค่าเพื่อสแกนบาร์โค้ด"
        case .openSettings: "เปิดการตั้งค่า"
        ...
        case .dataSourceInactiveDescription: "แหล่งข้อมูลนี้จะไม่ถูกใช้จนกว่าจะตั้งค่า"
        case .dataSourceAlternativeSearchAvailable: "รองรับการค้นหาสินค้าทางเลือก"
        case .dataSourceAlternativeSearchUnavailable: "รองรับเฉพาะการค้นหาสินค้าเดี่ยว"
        ...
        case .productLookupDataSourceUnauthorized: "แหล่งข้อมูลไม่ยอมรับคำขอในขณะนี้"
        case .limitedProductDataTitle: "ข้อมูลสินค้ามีจำกัด"
        case .limitedProductDataBody: "ข้อมูลสินค้ามีข้อมูลส่วนผสมหรือสารก่อภูมิแพ้ไม่เพียงพอสำหรับการประเมินที่เชื่อถือได้ โปรดตรวจสอบบรรจุภัณฑ์อย่างละเอียดเสมอ"
        ...
        case .dataSourceMergedDescription: "ข้อมูลสินค้าถูกรวมจากหลายแหล่งข้อมูลที่เปิดใช้งานอยู่"
